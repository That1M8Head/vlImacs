...
VlImacs is my personal Emacs config, containing stuff that I want Emacs to have because I like Emacs and it's cool. /But =vi= is cool too, so this config includes =evil-mode=./
